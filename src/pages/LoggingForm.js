      ...
      <form>
        ...
        <div>
          <div className='logging-form__input'>
            <input className='logging-form__input--data' type='email' placeholder='email' />
          </div>
          <div>
            <input className='logging-form__input--data' type='password' placeholder='hasło' />
          </div>
          <button className='button button-red button-info button-submit logging-form__input--button' type='submit'>
            zaloguj
          </button>
